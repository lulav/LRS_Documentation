...
**```Statistics```** :&ensp;**pandas.DataFrame** or **[CitrosStat](#citros_data_analysis.error_analysis.citros_stat.CitrosStat)**
...
**```db```** :&ensp;**[CitrosData](#citros_data_analysis.error_analysis.citros_data.CitrosData)**
...
**```value```** :&ensp;**int** or **[CitrosData](#citros_data_analysis.error_analysis.citros_data.CitrosData)**
:   &nbsp;
