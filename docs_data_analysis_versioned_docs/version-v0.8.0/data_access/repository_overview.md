...
```python
>>> print(citros.search_repo())
```
```text
{'projects': {'id': 'rrrrrrrr-1111-2222-aaaa-555555555555', 'description': 'statistics', ...}, 'citros_project': {'id': 'rrrrrrrr-1111-2222-3333-444444444444', ...}}
 ```
...
```python
>>> print(citros.search_repo().to_json())
```
```js
{
  "projects": {
...
Similar to the [**search_repo**](#repository-information), repository may be set by its name:
