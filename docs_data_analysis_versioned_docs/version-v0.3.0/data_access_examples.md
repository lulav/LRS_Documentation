...
[**CitrosDict**](documentation/data_access.md#citros_data_analysis.data_access.CitrosDict) object can be converted to json string by the method [**to_json()**](documentation/data_access.md#citros_data_analysis.data_access.CitrosDict.to_json) and printed:
```python
...
```
or printed by the method [**print()**](documentation/data_access.md#citros_data_analysis.data_access.CitrosDict.print) as it was shown above.
