...
/docs/data_analysis/data_access/access_ds
**```db```** :&ensp;**[CitrosData](/docs/data_analysis/data_error/error_ds#citros_data_analysis.error_analysis.CitrosData "citros_data_analysis.error_analysis.CitrosData")** or **None**
:   CitrosData object after binning or scaling.


**```stat```** :&ensp;**[CitrosStat](/docs/data_analysis/data_error/error_ds#citros_data_analysis.error_analysis.CitrosStat "citros_data_analysis.error_analysis.CitrosStat")** or **None**
:   CitrosStat object that stores mean, stndard deviation and covarian matrix as attributes.

---
#### See Also

**[CitrosData.bin_data()](/docs/data_analysis/data_error/error_ds#citros_data_analysis.error_analysis.CitrosData.bin_data "citros_data_analysis.error_analysis.CitrosData.bin_data"),**
**[CitrosData.scale_data()](/docs/data_analysis/data_error/error_ds#citros_data_analysis.error_analysis.CitrosData.scale_data "citros_data_analysis.error_analysis.CitrosData.scale_data")**
...
**```log```** :&ensp;**[CitrosDict](/docs/data_analysis/data_access/access_ds#citros_data_analysis.data_access.CitrosDict "citros_data_analysis.data_access.CitrosDict")**
