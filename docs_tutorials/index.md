...
- [Introduction to CITROS](#introduction-to-citros)
  - [Table of Contents](#table-of-contents)
  - [The Cannon Example Project](#the-cannon-example-project)
    - [Prerequisites](#prerequisites)
    - [Installation](#installation)
    - [Build](#build)
    - [Run The Analytic Solution](#run-the-analytic-solution)
    - [Run The Numeric Integration Solution](#run-the-numeric-integration-solution)
    - [Implementation Overview](#implementation-overview)
    - [Foxglove](#foxglove)
  - [Working with CITROS](#working-with-citros)
    ...
    - [Data analysis (online only)](#data-analysis-online-only)
